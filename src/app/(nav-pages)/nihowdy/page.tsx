...
const NihowdyPage = () => {
    return (
        <div className="flex flex-col items-center mt-10 gap-7 pb-5 md:mt-15 md:gap-15 md:pb-15 mx-10 md:mx-15">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 justify-center gap-5 md:gap-15 w-full lg:w-5xl">
            ...
            <div className="order-1 md:order-2 flex flex-col gap-2 md:gap-5 p-8 col-span-3 border border-gray-300 shadow-md/30 shadow-gray-600 rounded-xl">
              <h1 className="font-primary tracking-wider text-lg md:text-3xl">HOW CAN SCHOOLS JOIN NI-HOWDY?</h1>
              <h2 className="text-base md:text-xl mb-2 md:mb-0">Reach out to us on Instagram <b>@tamu.csa</b> or email us at <b>tamu.csa1963@gmail.edu</b> and let us know you'd like to join!</h2>
              <div className="flex flex-row gap-5">
                <LinkButton href="https://www.instagram.com/tamu.csa/" newTab={true}
                    className="text-sm md:text-lg"
                >
                  <div className="flex flex-row gap-2 items-center">
                    <RiInstagramFill className='size-4 md:size-6'/>
                    <p className="hidden md:block">Follow on Instagram</p>
                    <p className="block md:hidden">Instagram</p>
                  </div>
                </LinkButton>
                ...
                >
                  <div className="flex flex-row gap-2 items-center">
                    <RiMailFill className='size-4 md:size-6'/>
                    <p className="hidden md:block">Send Email</p>
                    <p className="block md:hidden">Email</p>
                  </div>
                </LinkButton>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-8 justify-center gap-5 md:gap-15 w-full lg:w-5xl">
            <div className="flex flex-col gap-2 md:gap-5 p-8 col-span-5 border border-gray-300 shadow-md/30 shadow-gray-600 rounded-xl">
          ...
          <div className="grid grid-rows-2 grid-cols-2 md:grid-rows-1 md:grid-cols-4 gap-4 md:gap-7 w-full max-w-5xl mx-auto">
          { 
