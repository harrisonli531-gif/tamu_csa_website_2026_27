...
import { GMSlideshowList } from "@/content/2026-2027/slides"; //UPDATE_HERE: change to 2026-2027 when that's created
    ...
    return (
        <div className='flex flex-col items-center gap-5 sm:gap-10 md:gap-10 mx-7 md:mx-10 md:pb-10'>
            <h2 className='container text-center font-secondary tracking-wide text-xl sm:text-3xl lg:text-4xl/12 mt-5 md:mt-15'>
                Come join us at our General Meeting <b>every other Thursday</b> in <b>PSYC 108</b> from <b>7-8 PM</b>! 
            ...
            {GMSlideshowList.toReversed().map((album) => (
                <SlideCard key={album.title} title={album.title} baseUrl={album.baseUrl} slug={album.slug} recapQuizUrl={album.recapQuizUrl} />
            ))}
            {/* Image Placeholders */}
