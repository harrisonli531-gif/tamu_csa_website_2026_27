...
export default async function SportsPage() {
  ...
  return <SportsPageComponent initialMedalsByJiating={medalsByJiating} initialSortedJiatingList={sortedJiatingList} />;
}

export const metadata: Metadata = {
  title: "TAMU CSA - Sports",
  description: "Explore the sports offerings of the Chinese Student Association at TAMU!",
};